...
@implementation IBAResourceManager (CoreGraphics)

ImplResourceNamed(size, CGSize, CGSizeZero)
ImplResourceNamed(rect, CGRect, CGRectZero)
ImplResourceNamed(point, CGPoint, CGPointZero)
